#!/bin/bash
# 基于 ConCutMix backbone 对图像进行分类，并引入知识库微调特征。但基于 Contrast 特征进行索引

# 迁移数据集时，需修改数据集名称、预训练模型地址
DATASET="ImageNet100-LT"
checkpoint="/home/Users/dqy/Projects/ConCutMix/log/baseline_ImageNet100-LT_resnet50_batchsize_256_epochs_100_temp_0.07_cutmix_prob_0.5_topk_30_scaling_factor_200_255_tau_0.99_lr_0.1_sim-sim/ConCutMix_ckpt.best.pth.tar"
# 考虑修改使用的 GPU 序号
device="0,1"
# 以下不用修改
